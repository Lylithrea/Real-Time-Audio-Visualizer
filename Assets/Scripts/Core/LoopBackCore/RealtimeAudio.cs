...
namespace Assets.Scripts.Audio
{
    public class RealtimeAudio
    {
        ...
        public void StartListen()
        {
            ...
            Console.WriteLine("sound channel:  " + _soundInSource.WaveFormat.Channels);
            ...
            _basicSpectrumProvider = new BasicSpectrumProvider(channel, _soundInSource.WaveFormat.SampleRate, CFftSize);
